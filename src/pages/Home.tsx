...
const Home: React.FC = () => {
  ...
  return (
    // Removido o <div> exterior desnecessário. <main> é o container principal.
    <main>
      {/* Seção Hero */}
      <section className="bg-blue-50 text-center py-20 px-6">
        ...
        <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
          ...
          */}
          ...
          {/* --- CORREÇÃO DE ROTA ---
              '/faq' (Saiba Mais) -> '/about' (para bater com a rota em App.tsx)
          */}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            */}
            ...
            {/* --- AVISO DE ROTA ---
                A rota '/resultados' não existe no App.tsx. 
                Vou redirecionar para a Home ('/') por enquanto.
                Se você criar a página 'Resultados', lembre-se de adicioná-la em App.tsx
            */}
            ...
            {/* --- CORREÇÃO DE ROTA ---
                '/contato' -> '/contact' (para bater com o App.tsx)
            */}
            <Link to="/contact" className="block p-8 bg-white rounded-lg shadow-lg text-center hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <div className="text-4xl mb-4">💬</div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          ...
          {/* Layout responsivo: 'flex-col' em mobile, 'md:flex-row' em desktop */}
          <div className="flex flex-col md:flex-row justify-center items-center text-center gap-10">
            ...
            {/* Seta divisória que some em mobile */}
